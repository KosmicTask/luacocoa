...
- (bool) promptUserToOpenLuaFileAtError:(NSString*)error_string
{
	...
	NSString* lua_file = [[NSBundle mainBundle] pathForResource:@"OpenSavePanelDelegate" ofType:@"lua"];
...
- (void) setupLuaCocoa
{
	...
	the_path = [[NSBundle mainBundle] pathForResource:@"OpenSavePanelDelegate" ofType:@"lua"];
